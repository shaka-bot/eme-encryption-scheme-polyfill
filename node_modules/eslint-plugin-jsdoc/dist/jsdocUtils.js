...
'modifies'];
const tagsWithOptionalTypeClosure = [...tagsWithOptionalType, // Shows the signature with curly brackets but not in the example
// "typeExpression"
...
const tagMightHaveAType = (mode, tag) => {
  return tagsWithMandatoryType.includes(tag) || (mode === 'closure' ? tagsWithOptionalTypeClosure.includes(tag) : tagsWithOptionalType.includes(tag));
};
